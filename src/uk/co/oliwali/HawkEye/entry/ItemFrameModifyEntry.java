...
public class ItemFrameModifyEntry extends DataEntry {
    ...
    public ItemFrameModifyEntry(String playerUuid, String player, Timestamp timestamp, int dataId, DataType type, String data, String world, int x, int y, int z) {
    ...
    public ItemFrameModifyEntry(Player player, DataType type, Location loc, ItemStack item) {
        super(PlayerIdentity.from(player), type, loc, serializer.serializeItem(item));
    }
